...
export const zeissTasks: Task[] = [
  // Part 1: 瞳距偏差 - 棱镜效应
  {
    ...
    partName: '瞳距偏差',
    title: '视疲劳情景图',
    description: '配戴一段时间后，可能出现眼眶周围酸胀，甚至伴有恶心、想吐的感觉。人物皮肤白皙无雀斑，眼镜偏右，眼睛不在镜片光学中心位置，表情难受痛苦。可以用手扶额头（手在眼镜上方），或者用手指按压太阳穴（手在眼镜外侧），注意手不能遮挡眼镜或穿过镜片。',
    status: 'pending',
  },
  {
    id: 'pd-2',
  ...
  },
  {
    ...
    partName: '镜面角偏差',
    title: '头晕恶心',
    description: '转头时可能出现"晃动感"，出现恶心感。人物皮肤白皙，佩戴眼镜后头晕恶心，表情痛苦难受。可以用手扶额头（手在眼镜上方）或捂嘴（手在眼镜下方），注意手不能遮挡眼镜或穿过镜片。',
    status: 'pending',
  },
];
